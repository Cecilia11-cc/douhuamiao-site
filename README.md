...
> 像树木一样安静生长 · 每次新发现，都会种在这片小森林里

一个安静的个人小站，用来记录数学学习、手作项目和日常思考。
...
| 文章 | 内容 |
|------|------|
| 数学分析级练习：概念、技巧与元思考 | 莱布尼茨公式拆解、极坐标的 r、f 连续的作用、对称消元法 |
| 微积分综合复习题集 | 40+ 题覆盖五大模块：定积分、多元微分、二重积分、级数、微分方程 |
| 二重积分进阶与空间几何生成 | 累次积分、区域边界 X/Y 型互换、母线与准线生成几何体 |
| 从微积分到测度：一次深度学习漫游 | 黎曼可积条件、勒贝格测度、连续统与势 |
| 定积分的几何应用、二重积分与矩 | 旋转体体积、壳层法、质心与转动惯量 |
| 二重积分：从原理到交换次序 | 积分次序策略、极坐标变换、对称性简化 |
| 求导、极限与积分：从定义到实战 | 极限定义、洛必达法则、换元法与分部积分 |
